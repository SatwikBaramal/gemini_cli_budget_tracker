...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-white dark:bg-gray-800/90 text-card-foreground flex flex-col gap-6 rounded-xl border-2 border-gray-200 dark:border-white/20 py-6 shadow-lg backdrop-blur-sm",
        className
      )}
      {...props}
    />
